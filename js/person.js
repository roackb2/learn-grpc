...
proto.Person.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hasPonycopter: jspb.Message.getBooleanFieldWithDefault(msg, 3, false)
  };
...
/**
 * optional bool has_ponycopter = 3;
 * @return {boolean}
 */
proto.Person.prototype.getHasPonycopter = function() {
 ...
 * @return {!proto.Person} returns this
 */
proto.Person.prototype.setHasPonycopter = function(value) {
